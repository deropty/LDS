...
def main(args):
    ...
    for idx, net in enumerate(model):
        ...
        save_image(image_dict, os.path.basename(args.image_path), idx, args.output_dir)(image_dict, os.path.basename(args.image_path), args.network, args.output_dir)
