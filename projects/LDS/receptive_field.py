            ...
            if not receptive_field["0"]["conv_stage"]:
                ...
                if class_name == "Conv2d" or class_name == "MaxPool2d" or class_name == "AvgPool2d":
                    ...
                    receptive_field[m_key]["start"] = p_start + ((kernel_size - 1) / 2 - padding) * p_j
                        ...
                        or class_name == "Bottleneck" or class_name == "BatchNorm"\
                        or class_name == "InstanceNorm2d" or class_name == "IBN"\
                        or class_name == "Identity" or class_name == "Non_local"\
                        or class_name == "ResNet":
