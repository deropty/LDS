...
from fastreid.evaluation import (ReidEvaluator, DSReidEvaluator,
...
class DefaultTrainer(TrainerBase):
    ...
    def __init__(self, cfg):
        ...
        if self.num_models != 0:
            self.checkpointer = LDSCheckpointer(
                model,
                cfg.OUTPUT_DIR,
                self.num_models,
    ...
    def build_evaluator(cls, cfg, dataset_name, output_dir=None):
        ...
        if cfg.MODEL.NUM_MODEL != 0:
            return data_loader, DSReidEvaluator(cfg, num_query, output_dir)
        else:
